...
const createSVGText = opt => {
  ...
  <svg height="100" width="100" viewbox="0 0 256 256" xmlns="http://www.w3.org/2000/svg">
    <rect x="10" y="50" width="100" height="75" stroke="red" fill="blue" stroke-width="5" />
    ...
    <circle cx="${getLength()}" cy="${getLength()}" r="${getLength() / 2}" fill="${getColor()}" />
    <circle cx="${getLength()}" cy="${getLength()}" r="${getLength() / 2}" fill="${getColor()}" />
    <text x="10" y="8" font-family="Verdana" font-size="8" fill="#555">z = ${opt.z}</text>
    <text x="10" y="16" font-family="Verdana" font-size="8" fill="#555">x = ${opt.x}</text>
    <text x="10" y="24" font-family="Verdana" font-size="8" fill="#555">y = ${opt.y}</text>
  </svg>
  `
}
